...
-- ----------------------------
INSERT INTO `django_session` VALUES ('9flpp3fn637fzpxjto6wupyxfh2euh8n', 'MDQ5OTg2M2EwZmM1ZDgxYzM4OGJkNjI5NjFiYmIxOWIxY2MxOGJkYjp7InVzZXJuYW1lIjoic3VtaUBnbWFpbC5jb20iLCJ1X2lkIjozLCJ1c2VyX3R5cGUiOiJ3b3JrZXIifQ==', '2019-04-26 09:17:42');
...
-- ----------------------------
-- Table structure for `tbl_insurence`
-- ----------------------------
DROP TABLE IF EXISTS `tbl_insurence`;
CREATE TABLE `tbl_insurence` (
  `insurence_id` int(10) NOT NULL AUTO_INCREMENT,
  `worker_id` varchar(10) NOT NULL,
  `emp_id` varchar(10) NOT NULL,
  `myworker_id` varchar(10) NOT NULL,
  `date` varchar(50) NOT NULL,
  `insurence_type` varchar(100) NOT NULL DEFAULT 'Life Insurence',
  `insurence_period` varchar(100) NOT NULL,
  `insurence_rupee` varchar(100) NOT NULL,
  `currently_insured` varchar(100) NOT NULL,
...
INSERT INTO `tbl_login` VALUES ('juna@gmail.com', 'juna', 'worker', '8', 'false');
...
INSERT INTO `tbl_login` VALUES ('kunju@gmail.com', 'kunju', 'worker', '7', 'false');
...
INSERT INTO `tbl_worker` VALUES ('8', 'pictures/Mega_HD_Wallpapers_115.jpg', 'juna thomas', 'female', '2019-04-12', 'hhh', '2019-04-11', 'jj', 'jj', 'jj', '0987654321', '0987654321', 'juna@gmail.com', 'juna', 'Pending');
...
INSERT INTO `tbl_workershedule` VALUES ('12', '12', '3', 'PLUMBER', '900', '2019-04-09', '10hr');
